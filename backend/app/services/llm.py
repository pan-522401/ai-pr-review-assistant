...
3. 每条风险包含：text, confidence(0-100), category, severity, reasoning, file, line
...
{{
    ...
    "risks": [
        {{"text": "风险描述", "confidence": 85, "category": "security", "severity": "high", "reasoning": "判断依据", "file": "backend/auth.py", "line": 45}},
        {{"text": "风险描述", "confidence": 70, "category": "performance", "severity": "medium", "reasoning": "判断依据", "file": "backend/api.py", "line": 102}},
        {{"text": "风险描述", "confidence": 55, "category": "boundary", "severity": "low", "reasoning": "判断依据", "file": "backend/utils.py", "line": 33}}
    ],
    "suggestions": [
